        ...
        <div className="flex flex-col items-center justify-start pb-[156px] w-[100%]">
              ...
              <div className="bg-white_A700 border-b-[1px] border-black_901 border-solid flex items-center justify-center w-[100%]">
                <div className="flex flex-col items-center justify-center w-[100%]">
                  <div className="h-[36px] relative w-[100%]">
                    ...
                    <div className="absolute bg-teal_900 flex sm:flex-col h-[100%] inset-[0] items-end sm:items-stretch sm:justify-between justify-center m-[auto] p-[10px] w-[100%]">
                  ...
                  <div className="bg-white_A700 flex items-center justify-start w-[100%]">
                    <div className="flex sm:flex-col sm:grid sm:items-center items-end sm:justify-center justify-start p-[16px] w-[100%]">
                  ...
                  <div className="border-black_901 border-solid border-t-[1px] flex items-end justify-start p-[12px] w-[100%]">
                    <div className="flex md:flex-col flex-row md:gap-[20px] sm:items-center items-end justify-end sm:justify-start ml-[auto] mr-[81px] pr-[3px] py-[3px] md:w-[100%] w-[79%]">
                      ...
                      <Text
                        className="font-semibold mb-[2px] md:ml-[0] ml-[36px] md:mt-[0] mt-[7px] text-black_901 text-left w-[auto]"
                        variant="body13"
                      >
                        Bli en leverandør
                      </Text>
                      <Text
                        className="font-normal md:ml-[0] ml-[38px] md:mt-[0] my-[4px] not-italic text-black_901 text-left w-[auto]"
                        variant="body13"
                      >
                        Få inspirasjon
                      </Text>
          ...
          <div className="flex flex-col md:px-[20px] relative w-[100%]">
            <div className="flex flex-col items-center justify-start mx-[auto] pb-[16px] w-[100%]">
              <div className="border-b-[1px] border-black_901 border-solid flex md:flex-col flex-row md:gap-[40px] items-start justify-between w-[100%]">
                ...
                <div className="flex md:flex-1 flex-col items-start justify-start md:mt-[0] mt-[64px] pt-[5px] md:w-[100%] w-[30%]">
                  ...
                  <div className="flex flex-col gap-[4px] items-start justify-start mt-[23px] sm:w-[100%] w-[auto]">
                    ...
                    <div className="flex flex-row gap-[8px] items-center justify-start pr-[3px] py-[3px] w-[100%]">
                      ...
                      <Text
                        className="font-normal mt-[3px] not-italic text-gray_901 text-left w-[auto]"
                        variant="body9"
                      >
              ...
              <div className="border-b-[1px] border-black_901 border-solid flex items-center justify-start w-[100%]">
                <div className="bg-white_A700 flex md:flex-col flex-row gap-[17px] items-center sm:items-stretch justify-center sm:justify-start p-[24px] sm:px-[20px] md:w-[100%] w-[63%]">
                  <div className="bg-gray_100 h-[56px] sm:h-[89px] md:ml-[0] ml-[23px] relative rounded-[28px] md:w-[100%] w-[85%]">
                    <div className="absolute sm:flex sm:flex-row h-[56px] sm:h-[89px] inset-[0] sm:items-center justify-center sm:justify-end m-[auto] w-[100%]">
              ...
              <div className="border-b-[1px] border-black_901 border-solid flex items-center justify-start w-[100%]">
                <div className="flex flex-col sm:flex-row gap-[24px] items-start justify-end p-[37px] sm:px-[20px] w-[100%]">
                  <Text
                    className="flex flex-col font-semibold md:ml-[0] ml-[18px] mt-[10px] text-gray_901 text-left w-[auto]"
                    variant="body4"
                  >
                  ...
                  <div className="sm:h-[1079px] h-[141px] md:h-[215px] md:ml-[0] ml-[18px] relative md:w-[100%] w-[98%]">
                    ...
                    <div className="absolute border-b-[1px] border-gray_902 border-solid flex flex-row h-[141px] inset-[0] justify-center m-[auto] w-[52%]"></div>
                  </div>
                </div>
              </div>
              <div className="border-b-[1px] border-black_901 border-solid flex items-center justify-start mt-[16px] pb-[16px] px-[16px] w-[100%]">
                  ...
                  <div className="flex flex-col gap-[32px] items-center justify-start my-[16px] w-[100%]">
                    <div className="md:h-[50px] sm:h-[63px] h-[69px] relative w-[100%]">
                      <div className="absolute md:h-[50px] h-[62px] inset-x-[0] mx-[auto] top-[0] w-[100%]">
                        ...
                        <div className="absolute bottom-[0] flex flex-row gap-[4px] sm:hidden items-start justify-center pb-[6.84px] pr-[8.3px] right-[5%] w-[auto]">
                          <Button className="bg-black_901 cursor-pointer font-semibold min-w-[117px] pb-[11.45px] pl-[17px] pr-[17.11px] pt-[9.55px] rounded-[22px] text-[15px] text-center text-white_A700 w-[auto]">
                            Get started
                          </Button>
                          <Img
                      ...
                      <div className="absolute bottom-[0] flex sm:flex-col flex-row gap-[25px] sm:hidden inset-x-[0] items-start justify-start mx-[auto] w-[100%]">
                        <Text
                    ...
                    <div className="flex flex-col gap-[32px] items-center justify-start w-[100%]">
                      <div className="flex md:flex-col flex-row md:gap-[20px] items-end sm:items-stretch sm:justify-around justify-start w-[100%]">
                        ...
                        <Button
                          className="bg-gray_51 border-[1px] border-light_blue_900 border-solid flex items-center justify-center md:ml-[0] ml-[34px] px-[25px] py-[19px] rounded-[27px] sm:px-[20px] text-center"
                          leftIcon={
                            <Img
                        ...
                        >
                          <div className="bg-transparent cursor-pointer font-semibold text-[14px] text-center text-light_blue_900">
                      ...
                      <div className="flex items-center justify-start w-[100%]">
                        ...
                        >
                          <div className="flex flex-1 md:flex-col md:gap-[30px] gap-[32px] grid-cols-4 items-center md:items-start justify-between md:justify-center my-[0] overflow-visible w-[100%]">
              ...
              <div className="border-b-[1px] border-black_901 border-solid flex flex-col items-start justify-start p-[64px] sm:px-[20px] md:px-[40px] w-[100%]">
                ...
                <div className="flex sm:flex-col flex-row gap-[40px] md:gap-[4px] grid-cols-6 items-start md:items-start md:justify-center justify-start sm:m-[0] md:m-[2px] overflow-auto md:p-[0] pl-[16px] py-[40px] md:w-[100%] w-[auto]">
              ...
              <div className="border-b-[1px] border-black_901 border-solid flex items-center justify-start w-[100%]">
                <List
                  className="flex sm:flex-col flex-row sm:gap-[10px] gap-[16.5px] grid-cols-[repeat(1,_1fr_1px)_1fr] items-center justify-center py-[16px] w-[99%]"
                  orientation="horizontal"
                >
                  ...
                  <div className="flex sm:ml-[0] relative w-[100%]">
                    <div className="bg-cyan_900 h-[470px] my-[auto] sm:w-[100%] w-[470px]">
                      <div className="bg-cyan_900 h-[470px] m-[auto] w-[99%]"></div>
                      <Img
              ...
              <div className="bg-bluegray_900 flex flex-col items-end justify-end mt-[16px] p-[22px] sm:px-[20px] rounded-[16px] md:w-[100%] w-[99%]">
                <div className="flex items-center justify-start mb-[81px] mt-[77px] w-[100%]">
                  <div className="flex flex-col md:gap-[40px] gap-[60px] items-center justify-start w-[100%]">
                    ...
                    <div className="flex sm:flex-col flex-row items-center justify-start md:w-[100%] w-[58%]">
                      ...
                      <SelectBox
                        className="font-normal not-italic py-[34px] sm:text-[36px] md:text-[42px] text-[46px] text-left text-white_A700 md:w-[100%] w-[97%]"
                        placeholderClassName="text-white_A700"
                        name="button One"
                        placeholder="Råd"
                        isSearchable={false}
            ...
            <div className="bg-gray_51 border-black_901 border-solid border-t-[1px] font-roboto sm:h-[1514px] md:h-[337px] h-[361px] mt-[-16.25px] mx-[auto] md:w-[100%] w-[99%] z-[1]">
              <div className="absolute bg-gray_51 border-black_901 border-solid border-t-[1px] flex h-[353px] md:hidden inset-y-[0] left-[0] my-[auto] w-[87%]"></div>
              <div className="absolute flex flex-col gap-[26px] md:h-[auto] h-[max-content] sm:hidden inset-[0] items-start justify-start m-[auto] max-w-[1885px] pt-[36px] w-[100%]">
                ...
                <div className="flex items-start justify-start md:w-[100%] w-[auto]">
                  <div className="flex flex-row gap-[16px] items-end justify-start md:m-[0] m-[4px] sm:overflow-scroll p-[20px] w-[100%]">
                            ...
                            <div className="h-[180px] pb-[148px] sm:pl-[20px] pl-[228.69px] md:pl-[40px] pr-[8px] pt-[8px] relative rounded-[8px] w-[320px]">
                              ...
                              <div className="absolute h-[180px] inset-[0] justify-center m-[auto] rounded-[8px] w-[100%]">
                                <Img
                                  ...
                                  className="flex flex-row h-[180px] m-[auto] object-cover w-[320px]"
                                  alt="div Ten"
                                />
